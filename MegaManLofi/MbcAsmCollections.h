...
namespace MbcAsm
{
   const std::vector<std::string> AllTokens =
   {
      ...
      MBCCOMP_GET_PLAYERVELX,
      MBCCOMP_GET_PLAYERVELY,
      MBCCOMP_GET_PLAYERDIR,
      MBCCOMP_GET_ENTPOSL,
      MBCCOMP_GET_ENTPOST,
      MBCCOMP_GET_ENTVELX,
      MBCCOMP_GET_ENTVELY,
   ...
   const std::map<std::string, mbc_command> GeneralTokenMap =
   {
      ...
      { MBCCOMP_GET_PLAYERVELX, MBCGET_PLAYERVELX },
      { MBCCOMP_GET_PLAYERVELY, MBCGET_PLAYERVELY },
      { MBCCOMP_GET_PLAYERDIR, MBCGET_PLAYERDIR },
   ...
   const std::map<std::string, int> TokenArgCountMap =
   {
      ...
      { MBCCOMP_GET_PLAYERVELX, 1 },
      { MBCCOMP_GET_PLAYERVELY, 1 },
      { MBCCOMP_GET_PLAYERDIR, 1 },
