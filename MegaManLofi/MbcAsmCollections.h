...
namespace MbcAsm
{
   ...
   const std::map<std::string, mbc_command> GeneralTokenMap =
   {
      ...
      { MBCCOMP_GET_PLAYERDAMAGESECONDS, MBCGET_PLAYERDAMAGESECONDS },
      { MBCCOMP_GET_PLAYERISINVULNERABLE, MBCGET_PLAYERISINVULNERABLE },
      { MBCCOMP_GET_PLAYERISKNOCKEDBACK, MBCGET_PLAYERISKNOCKEDBACK },
      { MBCCOMP_GET_PLAYERKNOCKBACKSECONDS, MBCGET_PLAYERKNOCKBACKSECONDS },
      { MBCCOMP_GET_PLAYERKNOCKBACKVELOCITY, MBCGET_PLAYERKNOCKBACKVELOCITY },
      ...
      { MBCCOMP_GET_DAMAGESECONDS, MBCGET_DAMAGESECONDS },
      { MBCCOMP_GET_ISINVULNERABLE, MBCGET_ISINVULNERABLE },
      { MBCCOMP_GET_ISKNOCKEDBACK, MBCGET_ISKNOCKEDBACK },
      { MBCCOMP_GET_KNOCKBACKSECONDS, MBCGET_KNOCKBACKSECONDS },
      { MBCCOMP_GET_KNOCKBACKVELOCITY, MBCGET_KNOCKBACKVELOCITY },
      ...
      { MBCCOMP_GET_ARENAENTITYISKNOCKEDBACK, MBCGET_ARENAENTITYISKNOCKEDBACK },
      { MBCCOMP_GET_ARENAENTITYKNOCKBACKSECONDS, MBCGET_ARENAENTITYKNOCKBACKSECONDS },
      { MBCCOMP_GET_ARENAENTITYKNOCKBACKVELOCITY, MBCGET_ARENAENTITYKNOCKBACKVELOCITY },
      { MBCCOMP_GET_RANDOMFLOAT, MBCGET_RANDOMFLOAT },
      { MBCCOMP_GET_RANDOMINT, MBCGET_RANDOMINT },
