...
#define MBCGET_PLAYERISINVULNERABLE 0x59     // get the player's invulnerability status

#define MBCGET_POSITIONLEFT         0x5A     // get the entity's left position in the arena
#define MBCGET_POSITIONTOP          0x5B     // get the entity's top position in the arena
#define MBCGET_VELOCITYX            0x5C     // get the entity's X velocity
#define MBCGET_VELOCITYY            0x5D     // get the entity's Y velocity
#define MBCGET_DIRECTION            0x5E     // get the entity's direction
#define MBCGET_HEALTH               0x5F     // get the entity's health
#define MBCGET_MAXHEALTH            0x60     // get the entity's max health
#define MBCGET_MOVEMENTTYPE         0x61     // get the entity's movement type
#define MBCGET_ISINVULNERABLE       0x62     // get the entity's invulnerability status
