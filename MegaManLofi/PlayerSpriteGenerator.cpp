...
map<Direction, ConsoleSprite> PlayerSpriteGenerator::GenerateStaticSpriteMap()
{
   ...
   for ( auto line : { "  O ",
                       "o-|\\",
                       " / \\" } ) { for ( int i = 0; i < spriteMap[Direction::Left].Width; i++ ) { spriteMap[Direction::Left].Pixels.push_back( { line[i], ConsoleColor::White } ); } }
   ...
   for ( auto line : { "o O ",
                       " `|\\",
                       " / \\" } ) { for ( int i = 0; i < spriteMap[Direction::UpLeft].Width; i++ ) { spriteMap[Direction::UpLeft].Pixels.push_back( { line[i], ConsoleColor::White } ); } }
   ...
   for ( auto line : { "  O ",
                       " ,|\\",
                       "o/ \\" } ) { for ( int i = 0; i < spriteMap[Direction::DownLeft].Width; i++ ) { spriteMap[Direction::DownLeft].Pixels.push_back( { line[i], ConsoleColor::White } ); } }
   ...
   for ( auto line : { " O  ",
                       "/|-o",
                       "/ \\ " } ) { for ( int i = 0; i < spriteMap[Direction::Right].Width; i++ ) { spriteMap[Direction::Right].Pixels.push_back( { line[i], ConsoleColor::White } ); } }
   ...
   for ( auto line : { " O o",
                       "/|' ",
                       "/ \\ " } ) { for ( int i = 0; i < spriteMap[Direction::UpRight].Width; i++ ) { spriteMap[Direction::UpRight].Pixels.push_back( { line[i], ConsoleColor::White } ); } }
   ...
   for ( auto line : { " O  ",
                       "/|. ",
                       "/ \\o" } ) { for ( int i = 0; i < spriteMap[Direction::DownRight].Width; i++ ) { spriteMap[Direction::DownRight].Pixels.push_back( { line[i], ConsoleColor::White } ); } }
   ...
   for ( auto line : { " Oo ",
                       "/|' ",
                       "/ \\ " } ) { for ( int i = 0; i < spriteMap[Direction::Up].Width; i++ ) { spriteMap[Direction::Up].Pixels.push_back( { line[i], ConsoleColor::White } ); } }
   ...
   for ( auto line : { " O  ",
                       "/|. ",
                       "/`o " } ) { for ( int i = 0; i < spriteMap[Direction::Down].Width; i++ ) { spriteMap[Direction::Down].Pixels.push_back( { line[i], ConsoleColor::White } ); } }
